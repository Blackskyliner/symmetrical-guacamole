...
<template>
  ...
  <div
    class="top-0 before:top-0 after:top-0 right-8 after:right-0 bottom-0 left-8 before:left-0 fixed xl:absolute before:absolute after:absolute xl:inset-0 mx-auto before:w-px after:w-px max-w-screen-xl before:h-full after:h-full before:content-[''] after:content-[''] before:[background:repeating-linear-gradient(0deg,var(--sand-5)_0_4px,transparent_0_8px)] after:[background:repeating-linear-gradient(0deg,var(--sand-5)_0_4px,transparent_0_8px)]"
  ></div>

  <div class="flex flex-col pt-4 h-full">
    <!-- Header -->
    <div class="flex justify-center items-center bg-gradient-to-b from-sand-1 to-sand-2 pb-4 grow">
      <a href="https://adonisjs.com" target="_blank" class="isolate">
        <svg class="fill-primary w-16 h-16" viewBox="0 0 33 33">
          <path
            fill-rule="evenodd"
    ...
    <div
      class="isolate gap-8 grid grid-cols-1 xl:grid-cols-2 xl:grid-rows-3 mx-auto mt-10 px-16 xl:px-8 max-w-screen-xl"
    >
      <article
        class="group relative flex flex-col gap-8 row-span-3 shadow-sm hover:shadow p-6 border border-sand-7 hover:border-sand-8 rounded-2xl transition duration-700 ease-in-out"
      >
        <div class="relative opacity-80">
          ...
          <div
            class="right-0 bottom-0 left-0 absolute bg-gradient-to-b from-white/0 to-white h-16"
          ></div>
        </div>

        <div class="flex flex-row gap-4">
          <div class="flex justify-center items-center bg-primary/20 rounded-md w-10 h-10 shrink-0">
            <svg class="fill-primary w-6 h-6" viewBox="0 0 256 256">
              <path
                fill="currentColor"
          ...
          <div class="space-y-1">
            ...
            <p
              class="group-hover:text-sand-12 text-sand-11 text-sm transition duration-700 ease-in-out"
            >
      ...
      <article
        class="group relative flex flex-row gap-4 shadow-sm hover:shadow p-6 border border-sand-7 hover:border-sand-8 rounded-2xl transition duration-700 ease-in-out"
      >
        <div class="flex justify-center items-center bg-primary/20 rounded-md w-10 h-10 shrink-0">
          <svg class="fill-primary w-6 h-6" viewBox="0 0 256 256">
            <path
    ...
    <!-- Features -->
    <div class="mx-auto mt-10 mb-8 px-16 xl:px-8 max-w-screen-xl grow">
      <div class="gap-4 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
        <article
          class="group relative bg-white hover:shadow-sm px-5 py-4 border hover:border-sand-8 border-transparent rounded-lg transition duration-100 ease-in-out"
        >
          <h2 class="font-semibold text-sand-12">
            <a href="https://lucid.adonisjs.com" target="_blank" class="flex flex-row gap-2">
              <span class="flex justify-center items-center bg-[#D5EAE7] rounded w-6 h-6">
                <svg class="fill-[#0E766E] w-4 h-4" viewBox="0 0 24 24">
                  <g
                    fill="none"
                    stroke="currentColor"
          ...
          <p
            class="group-hover:text-sand-12 mt-4 text-sand-11 text-sm transition duration-100 ease-in-out"
          >
          ...
          <svg
            class="top-4 right-5 absolute opacity-0 group-hover:opacity-100 w-4 h-4 text-sand-9 transition duration-100 ease-in-out"
            viewBox="0 0 24 24"
          >
            <path
              fill="none"
        ...
        >
          <h2 class="font-semibold text-sand-12">
            <a href="https://vinejs.dev/" target="_blank" class="flex flex-row gap-2">
              <span class="flex justify-center items-center bg-[#F3DBFC] rounded w-6 h-6">
                <svg class="fill-[#CA5AF2] w-4 h-4" viewBox="0 0 24 24">
                  <path
                    fill="none"
                    stroke="currentColor"
                    stroke-linecap="round"
        ...
        >
          <h2 class="font-semibold text-sand-12">
            <a href="https://inertiajs.com/" target="_blank" class="flex flex-row gap-2">
              <span class="flex justify-center items-center bg-[#B8EAE0] rounded w-6 h-6">
                <svg class="fill-[#4BBBA5] w-4 h-4" viewBox="0 0 24 24">
                  <path
                    fill="none"
                    stroke="currentColor"
                    stroke-linecap="round"
        ...
        >
          <h2 class="font-semibold text-sand-12">
            <a href="https://japa.dev" target="_blank" class="flex flex-row gap-2">
              <span class="flex justify-center items-center bg-[#FACDDC] rounded w-6 h-6">
                <svg class="fill-[#DD3074] w-4 h-4" viewBox="0 0 256 256">
                  <path
                    fill="currentColor"
